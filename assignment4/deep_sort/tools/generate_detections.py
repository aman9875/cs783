...
def main():
    ...
    video = "/home/aman9875/Documents/deep_sort/output2.mp4"
    name_out = "detections2"
    path = "/home/aman9875/Documents/deep_sort/detections2.csv"
    detection = genfromtxt(path,delimiter = ',')
    generate_detections_video(encoder,video,name_out,detection)
