...
vs = cv2.VideoCapture("/home/aman9875/Documents/deep_sort/output2.mp4")
writer = None
...
frame_number = 0
data = genfromtxt('/home/aman9875/Documents/deep_sort/results.csv',delimiter = ',')
data.astype(int)
print(data[:,1])
...
# 		break
	...
	# classIds = data[idx,2]
	trackid = data[idx,1]
	for bb,tid in zip(bbox,trackid):
	...
	if writer is None:
		...
		writer = cv2.VideoWriter("trackoutput12.avi", fourcc, 30,
